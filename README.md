...
The app also uses **Redis** for caching frequently accessed data, which helps keep responses fast and the UI feeling more responsive when loading feeds, profiles, and connection data.
